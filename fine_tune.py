...
# DataLoader
train_loader = DataLoader(dataset=train_dataset, batch_size=32, shuffle=True, num_workers=2)  # Reduced batch size
val_loader = DataLoader(dataset=val_dataset, batch_size=8, shuffle=False, num_workers=1)  # Reduced batch size
